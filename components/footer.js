    ...
    <footer className="min-h-0 bg-tabs">
      <div className="py-6 mx-auto max-w-xs lg:max-w-7xl">
        ...
        <div className="text-white uppercase text-center  grid  grid-cols-1 ">
          ...
          <button
              className="text-center lg:text-left mt-4 flex   place-items-center  lg:place-content-start  col-span-4"
            >
              <div className="text-gold "> </div> Anusawari, Bang Khen, Bangkok
              10220
            </button>{" "}
            <div className="flex justify-center">
              <button
            
                className="text-center lg:text-left mt-4 flex   place-items-center  col-span-1"
              >
        ...
        <div className="mt-4 flex text-white justify-center text-xs ">
